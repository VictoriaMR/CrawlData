    ...
    protected function createTables()
    {
        ...
        if (!Capsule::schema()->hasTable($sTable))
        {
            Capsule::schema()->create($sTable, function (Blueprint $oTable) {
                ...
                $oTable->char('num1', 2)->default('');
                $oTable->char('num2', 2)->default('');
                $oTable->char('num3', 2)->default('');
                $oTable->char('num4', 2)->default('');
                $oTable->char('num5', 2)->default('');
                $oTable->char('num6', 2)->default('');
                $oTable->char('num7', 2)->default('');
                $oTable->char('qishu', 10)->default('');
            });
